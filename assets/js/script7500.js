...
!(function(e) {
	...
	if (l.length > 0) {
		...
		t.scroll(function() {
			var e = t.scrollTop(),
				a = r.height();
			e > c.top
				? l.hasClass('has-fixed') || (l.addClass('has-fixed'), s.css('padding-top', a))
				: l.hasClass('has-fixed') && (l.removeClass('has-fixed'), s.css('padding-top', 0));
		});
	}
	...
	T.length > 0 &&
		...
		S.length > 0 &&
			S.each(function() {
				e(this).datepicker({ format: 'mm/dd/yyyy', startView: 2, maxViewMode: 2, clearBtn: !0, autoclose: !0 });
			}),
		_.length > 0 &&
			_.each(function() {
				e(this)
					...
					xAxes: [
						{
							...
							gridLines: { color: 'transparent', tickMarkLength: 20, zeroLineColor: '#e5ecf8' },
						},
					],
				},
			},
